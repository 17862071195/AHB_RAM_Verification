...
# DVE full session
# Saved on Mon Feb 27 23:06:38 2023
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{1 38} {2560 1374}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 428} {child_wave_right 2126} {child_wave_colname 212} {child_wave_colvalue 212} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_env SIMSETUP::SIMARGS {{-ucligui -l run.log +ntb_random_seed_automatic +UVM_TESTNAME=ahb_ram_haddr_word_unaligned_test -UVM_VERBOSITY=UVM_HIGH -cm_dir out/cov.vdb -cm_name ahb_ram_haddr_word_unaligned_test_0227152715 -do ahb_ram_sim_run.do}}
...
gui_sim_run Ucli -exe ahb_ram_tb.simv -args {-ucligui -l run.log +ntb_random_seed_automatic +UVM_TESTNAME=ahb_ram_haddr_word_unaligned_test -UVM_VERBOSITY=UVM_HIGH -cm_dir out/cov.vdb -cm_name ahb_ram_haddr_word_unaligned_test_0227152715 -do ahb_ram_sim_run.do} -dir /home/verifier/DVT_Code/AHB_RAM/uvm/sim/out/obj -nosource
}
}
...
gui_wv_zoom_timerange -id ${Wave.1} 1084259 1183747
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_select -id ${Wave.1} {ahb_ram_tb.dut.HADDR }
...
gui_marker_move -id ${Wave.1} {C1} 1134000
