...
# DVE full session
# Saved on Thu Feb 23 22:23:08 2023
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 366} {height 416} {dock_state left} {dock_on_new_line true} {child_hier_colhier 331} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 636]
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 636
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 415
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 635} {height 416} {dock_state left} {dock_on_new_line true} {child_data_colvariable 314} {child_data_colvalue 147} {child_data_coltype 168} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 835]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 2500
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 835
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 2559} {height 834} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMARGS {{-a run.log +ntb_random_seed_automatic +UVM_TESTNAME=ahb_ram_diff_hsize_test -UVM_VERBOSITY=UVM_HIGH -cm_dir out/cov.vdb -cm_name ahb_ram_diff_hsize_test_0223210808 -do ahb_ram_sim_run.do}}
...
gui_sim_run Ucli -exe ahb_ram_tb.simv -args { -a run.log +ntb_random_seed_automatic +UVM_TESTNAME=ahb_ram_diff_hsize_test -UVM_VERBOSITY=UVM_HIGH -cm_dir out/cov.vdb -cm_name ahb_ram_diff_hsize_test_0223210808 -do ahb_ram_sim_run.do -ucligui} -dir /home/verifier/DVT_Code/AHB_RAM/uvm/sim/out/obj -nosource
}
}
...
gui_view_scroll -id ${Source.1} -vertical -set 4280
