...
# DVE full session
# Saved on Mon Feb 27 23:20:45 2023
# Designs open: 1
...
gui_set_env SIMSETUP::SIMARGS {{-ucligui -l run.log +ntb_random_seed_automatic +UVM_TESTNAME=ahb_ram_diff_haddr_test -UVM_VERBOSITY=UVM_HIGH -cm_dir out/cov.vdb -cm_name ahb_ram_diff_haddr_test_0227230558 -do ahb_ram_sim_run.do}}
...
gui_sim_run Ucli -exe ahb_ram_tb.simv -args {-ucligui -l run.log +ntb_random_seed_automatic +UVM_TESTNAME=ahb_ram_diff_haddr_test -UVM_VERBOSITY=UVM_HIGH -cm_dir out/cov.vdb -cm_name ahb_ram_diff_haddr_test_0227230558 -do ahb_ram_sim_run.do} -dir /home/verifier/DVT_Code/AHB_RAM/uvm/sim/out/obj -nosource
}
}
...
gui_wv_zoom_timerange -id ${Wave.1} 66557032 66634955
