...
# DVE full session
# Saved on Thu Feb 23 21:07:49 2023
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{1 260} {2560 1596}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 482} {child_wave_right 2072} {child_wave_colname 263} {child_wave_colvalue 214} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_env SIMSETUP::SIMARGS {{-a run.log +ntb_random_seed_automatic +UVM_TESTNAME=ahb_ram_diff_hsize_test -UVM_VERBOSITY=UVM_HIGH -cm_dir out/cov.vdb -cm_name ahb_ram_diff_hsize_test_0223205737 -do ahb_ram_sim_run.do}}
...
gui_sim_run Ucli -exe ahb_ram_tb.simv -args { -a run.log +ntb_random_seed_automatic +UVM_TESTNAME=ahb_ram_diff_hsize_test -UVM_VERBOSITY=UVM_HIGH -cm_dir out/cov.vdb -cm_name ahb_ram_diff_hsize_test_0223205737 -do ahb_ram_sim_run.do -ucligui} -dir /home/verifier/DVT_Code/AHB_RAM/uvm/sim/out/obj -nosource
}
}
...
gui_wv_zoom_timerange -id ${Wave.1} 141896 286111
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_select -id ${Wave.1} {ahb_ram_tb.dut.HWDATA }
...
gui_marker_move -id ${Wave.1} {C1} 238000
