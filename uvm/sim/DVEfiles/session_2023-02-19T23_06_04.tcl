...
# DVE full session
# Saved on Sun Feb 19 23:06:04 2023
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{1 112} {1918 1086}}
...
gui_set_env SIMSETUP::SIMARGS {{-a run.log +ntb_random_seed_automatic +UVM_TESTNAME=ahb_ram_smoke_test -cm_dir out/cov.vdb -cm_name ahb_ram_smoke_test_0219224518 -do ahb_ram_sim_run.do}}
...
gui_sim_run Ucli -exe ahb_ram_tb.simv -args { -a run.log +ntb_random_seed_automatic +UVM_TESTNAME=ahb_ram_smoke_test -cm_dir out/cov.vdb -cm_name ahb_ram_smoke_test_0219224518 -do ahb_ram_sim_run.do -ucligui} -dir /home/verifier/DVT_Code/AHB_RAM/uvm/sim/out/obj -nosource
}
}
...
gui_wv_zoom_timerange -id ${Wave.1} 69490 141291
...
gui_marker_move -id ${Wave.1} {C1} 464304
