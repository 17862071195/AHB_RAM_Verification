...
# DVE full session
# Saved on Sun Feb 19 22:44:34 2023
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{1 75} {1919 1050}}
...
gui_set_env SIMSETUP::SIMARGS {{-ucligui -l run.log +ntb_random_seed_automatic +UVM_TESTNAME=ahb_ram_smoke_test -cm_dir out/cov.vdb -cm_name ahb_ram_smoke_test_0219214312 -do ahb_ram_sim_run.do}}
...
gui_sim_run Ucli -exe ahb_ram_tb.simv -args {-ucligui -l run.log +ntb_random_seed_automatic +UVM_TESTNAME=ahb_ram_smoke_test -cm_dir out/cov.vdb -cm_name ahb_ram_smoke_test_0219214312 -do ahb_ram_sim_run.do} -dir /home/verifier/DVT_Code/AHB_RAM/uvm/sim/out/obj -nosource
}
}
...
# Global: Breakpoints
stop -file {/home/verifier/DVT_Code/AHB_RAM/uvm/sim/../vip_lib/lvc_ahb/lvc_ahb_master_driver.sv}  -line {27}   
stop -file {/home/verifier/DVT_Code/AHB_RAM/uvm/sim/../vip_lib/lvc_ahb/lvc_ahb_master_driver.sv}  -line {41}   
stop -file {/home/verifier/DVT_Code/AHB_RAM/uvm/sim/../vip_lib/lvc_ahb/lvc_ahb_master_driver.sv}  -line {42}   
...
gui_wv_zoom_timerange -id ${Wave.1} 26121 78013
...
gui_marker_move -id ${Wave.1} {C1} 78000
